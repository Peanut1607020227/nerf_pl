...
def IBRay_NOPC(data_folder_path, h,w,focal,skip_step ):
    ...
    NHR_dataset = IBRDynamicDataset(data_folder_path, 1, True, transforms, [1.0, 6.5, 0.8], skip_step = skip_step, random_noisy = 0, holes='None',NOH=True)
...
class NOPCDataset(Dataset):
    ...
    def read_meta(self):
        ...
        images, poses, hwf, mask_nhr,near,far = IBRay_NOPC(self.root_dir,w,h,self.focal,1)
